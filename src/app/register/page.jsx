...
export default function RegistrationForm() {
  ...
  return (
    <div className='flex items-center content-center h-screen w-full bg-[#0F102B]'>
      <div className='w-md h-[65%] mx-auto mt-10 bg-[#23243D] p-6 rounded-xl shadow-xl shadow-[#434458] text-white'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
          ...
          <button
            type='submit'
            className='w-full bg-white  font-extrabold text-[#23243D] p-2 rounded-lg mt-2 hover:bg-[#55B3C3] hover:text-white transition-all hover:scale-105 cursor-pointer'
          >
            Registrar
          </button>
          {serverError && (
